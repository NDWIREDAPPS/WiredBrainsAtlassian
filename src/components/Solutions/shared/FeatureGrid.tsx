...
function CarouselArrows() {
    ...
    return (
        <>
            <button
                onClick={scrollPrev}
                className="absolute top-1/2 -left-6 md:-left-12 -translate-y-1/2 p-2 text-slate-400 hover:text-purple-600 transition-colors"
            ...
            <button
                onClick={scrollNext}
                className="absolute top-1/2 -right-6 md:-right-12 -translate-y-1/2 p-2 text-slate-400 hover:text-purple-600 transition-colors"
                    ...
                    >
                        <CarouselContent className="-ml-4 items-stretch py-4">
                            {features.map((feature) => (
                                <CarouselItem key={feature.title} className={`pl-4 ${carouselBasis[columns]} h-auto`}>
                                    <FeatureCard
                                        title={feature.title}
