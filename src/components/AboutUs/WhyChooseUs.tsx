    ...
    <section className="container mx-auto px-4 md:px-10">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-semibold tracking-tight text-foreground mb-4 font-display">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {whyChooseUs.map((reason, index) => (
            <li
              key={index}
              className="flex items-start gap-4 bg-card p-6 rounded-2xl border border-[#f14a15]/20 shadow-xs hover:border-[#f14a15]/50 hover:shadow-md transition-all"
            >
        ...
        <p className="text-center text-primary font-semibold mt-12 text-xl italic">
