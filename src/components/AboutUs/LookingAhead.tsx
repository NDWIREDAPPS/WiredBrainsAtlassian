      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-base sm:text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
            ...
            Achlys Solutions is focused on pioneering the next wave of
            productivity:
          </p>
        </div>
        ...
        <div className="grid gap-6">
          {futureGoals.map((goal, index) => {
            ...
            return (
              <div
                key={index}
                className="flex items-center gap-6 bg-white p-6 rounded-2xl border border-purple-100 shadow-xs hover:border-purple-300 transition-all group"
              >
                ...
                <span className="text-slate-800 text-xl font-medium leading-snug">
                  {goal.text}
                </span>
              </div>
            )
