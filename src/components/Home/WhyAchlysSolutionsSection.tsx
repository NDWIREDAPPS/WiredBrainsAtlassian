      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="text-left space-y-4">
          ...
          <p className="text-lg sm:text-xl font-semibold text-primary font-display">
            Why Teams Choose Wired Brains
          </p>
          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl">
            We don't just configure Atlassian tools-we engineer solutions around
            how teams actually work, ensuring long-term scalability and
            security.
          </p>
        </div>
