  ...
  head: () => ({
    meta: [
      { title: 'IT Service Management (ITSM) Solutions | Wired Brains' },
      {
        name: 'description',
        content:
          'Modern ITSM and ESM solutions built on Jira Service Management. Incident, request, problem and change management aligned with ITIL best practices.',
      },
      {
        property: 'og:title',
      ...
      },
      {
        ...
        content:
          'Modern ITSM and ESM solutions built on Jira Service Management aligned with ITIL best practices.',
      },
      {
        property: 'og:url',
        content: 'https://achlyssolutions.netlify.app/solutions/itsm',
      },
    ],
  }),
  component: ITSMPage,
  ...
  const capabilities: FeatureItem[] = [
    {
      ...
      description:
        'Rapid detection, triage and resolution of incidents to minimize business impact. We configure workflows, SLAs, escalations and automation to ensure faster response times and improved service reliability.',
      icon: AlertTriangle,
    },
    {
      title: 'Request Management',
      description:
        'Streamlined service request portals for IT and business teams, enabling employees to easily request services such as access, hardware, software and support-without unnecessary complexity.',
      icon: FileQuestion,
    },
    {
      title: 'Problem Management',
      description:
        'Structured root cause analysis and problem resolution to reduce recurring incidents. We design problem workflows that focus on long-term stability and continuous improvement.',
      icon: Search,
    },
    {
      title: 'Change Management',
      description:
        'Controlled and auditable change processes to reduce risk while maintaining agility. Our change management solutions support approvals, risk assessments and deployment visibility.',
      icon: RefreshCw,
    },
    {
      title: 'Asset & Configuration Management',
      description:
        'Integrated asset and configuration tracking to maintain visibility into infrastructure, applications and dependencies-supporting informed decision-making and operational governance.',
      icon: Database,
    },
  ]
  ...
  const automationFeatures: FeatureItem[] = [
    {
      ...
      description:
        'Automated ticket routing and approvals to eliminate manual work and speed up service delivery.',
      icon: Zap,
    },
    {
      title: 'SLA Management',
      description:
        'SLA tracking and breach prevention to ensure service level commitments are met consistently.',
      icon: BarChart3,
    },
    {
      title: 'Tool Integrations',
      description:
        'Integrations with monitoring, identity and collaboration tools for seamless operations.',
      icon: Database,
    },
    {
      title: 'Custom Workflows',
      description:
        'Custom workflows aligned with organizational processes for maximum efficiency.',
      icon: RefreshCw,
    },
  ]
