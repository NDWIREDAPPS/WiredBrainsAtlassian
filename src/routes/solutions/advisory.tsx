...
import { Target, Layout, CreditCard, Package, Map, Shield } from 'lucide-react'
  ...
  head: () => ({
    meta: [
      { title: 'Advisory & Licensing | Achlys Solutions' },
      {
        name: 'description',
        content:
          'Strategic Atlassian advisory and licensing guidance. Tool selection, architecture design, licensing optimization and Marketplace app advisory.',
      },
      {
        property: 'og:title',
      ...
      },
      {
        ...
        content:
          'Strategic Atlassian advisory including tool selection, architecture design and licensing optimization.',
      },
      {
        property: 'og:url',
        content: 'https://achlyssolutions.netlify.app/solutions/advisory',
      },
    ],
  }),
  ...
  const services: FeatureItem[] = [
    {
      ...
      description:
        'We help organizations identify the right Atlassian products based on use cases, scale and maturity-including Jira Software, Jira Service Management, Confluence and Jira Align. Our recommendations focus on long-term value-not over-tooling.',
      icon: Target,
    },
    {
      title: 'Architecture & Design Advisory',
      description:
        'We provide guidance on designing scalable, secure and maintainable Atlassian architectures, covering project and space structures, permission and access models, workflow and automation patterns and cloud-native designs.',
      icon: Layout,
    },
    {
      title: 'Licensing Optimization',
      description:
        'We help organizations understand and optimize Atlassian licensing by reviewing current usage, identifying under- or over-utilization, aligning editions to actual needs and supporting co-terming and future planning.',
      icon: CreditCard,
    },
    {
      title: 'Marketplace App Advisory',
      description:
        'As Atlassian Marketplace app developers, we advise on app selection and consolidation, cloud-compatible and Forge-based alternatives and risk, security and performance considerations.',
      icon: Package,
    },
  ]
  ...
  const governanceItems: FeatureItem[] = [
    {
      ...
      description:
        'Establishing clear governance frameworks and standardization practices across your Atlassian platform.',
      icon: Shield,
    },
    {
      title: 'Security & Compliance',
      description:
        'Security and compliance considerations tailored to your industry and regulatory requirements.',
      icon: Shield,
    },
    {
      title: 'Platform Sustainability',
      description:
        'Platform sustainability and maintainability to ensure long-term operational success.',
      icon: Map,
    },
    {
      title: 'Operating Models',
      description:
        'Clear ownership and operating models for effective platform management.',
      icon: Layout,
    },
  ]
