  ...
  const audiences: FeatureItem[] = [
    {
      ...
      description: "Training for Jira and Confluence administrators focused on configuration, workflows, permissions, automation, governance, and platform maintenance.",
      icon: Settings
    },
    {
      title: "Developers",
      description: "Technical training for developers covering Jira APIs, Atlassian Forge, Custom UI, integrations, automation, and app development best practices.",
      icon: Code
    },
    {
      title: "Agents",
      description: "Practical training for Jira Service Management agents on ticket handling, SLAs, queues, automations, collaboration, and service excellence.",
      icon: Headphones
    },
    {
      title: "End Users",
      description: "User-friendly training to help teams navigate Jira, Confluence, and service portals confidently, improving adoption and productivity.",
      icon: Users
    }
  ]
  ...
  const approaches: FeatureItem[] = [
    {
      ...
      description: "We focus on real use cases, live demonstrations, and guided exercises—ensuring participants can apply what they learn immediately.",
      icon: BookOpen
    },
    {
      title: "Best Practices Aligned",
      description: "Training is aligned with Atlassian-recommended patterns and industry best practices, helping teams avoid common pitfalls and over-customization.",
      icon: Target
    },
    {
      title: "Customized to Your Environment",
      description: "Sessions are customized to your Jira projects, workflows, and service processes—not generic examples.",
      icon: Layers
    },
    {
      title: "Adoption-Focused",
      description: "We emphasize usability, consistency, and clarity so teams feel confident using Atlassian tools long after training ends.",
      icon: Heart
    }
  ]
