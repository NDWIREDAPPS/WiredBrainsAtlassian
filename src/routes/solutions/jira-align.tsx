    ...
    const deliverables: FeatureItem[] = [
        {
            ...
            description: "We help organizations define and structure strategic themes, objectives, and investment horizons—ensuring leadership has clear visibility into where time, effort, and funding are being spent.",
            icon: Target
        },
        {
            title: "Program & Value Stream Design",
            description: "We design value streams, programs, and team structures that reflect how work actually flows across the organization—reducing silos and improving flow.",
            icon: GitBranch
        },
        {
            title: "Execution Visibility",
            description: "We connect Jira Align with execution tools like Jira Software, enabling real-time visibility from strategy down to epics, stories, and delivery progress.",
            icon: Eye
        },
        {
            title: "Dependency & Risk Management",
            description: "We configure Jira Align to identify dependencies, risks, and bottlenecks early—helping organizations proactively manage delivery challenges.",
            icon: AlertTriangle
        }
    ]
    ...
    const steps: ProcessStep[] = [
        {
            ...
            description: "We assess organizational maturity, operating models, and existing agile practices to ensure Jira Align is implemented in a way that fits your organization—not forced onto it."
        },
        {
            title: "Configuration & Integration",
            description: "We configure Jira Align structures, hierarchies, and integrations to reflect your enterprise model, while maintaining clarity and simplicity."
        },
        {
            title: "Enablement & Training",
            description: "We enable leaders, portfolio managers, and delivery teams with role-based training focused on real-world usage—not theory."
        },
        {
            title: "Adoption & Continuous Improvement",
            description: "Post-implementation, we support adoption, refinement, and optimization to ensure Jira Align becomes part of daily decision-making."
        }
    ]
    ...
    const ecosystemItems: FeatureItem[] = [
        {
            ...
            description: "Connect high-level business goals and strategic initiatives to measurable outcomes.",
            icon: Target
        },
        {
            title: "Portfolio Investment Decisions",
            description: "Make informed investment decisions based on real-time portfolio visibility.",
            icon: Layers
        },
        {
            title: "Program Execution & Delivery",
            description: "Track program execution and delivery progress across teams and value streams.",
            icon: GitBranch
        },
        {
            title: "Team-Level Work in Jira",
            description: "Connect strategy to the actual work being done by teams in Jira Software.",
            icon: Eye
        }
    ]
