    ...
    const helpItems: FeatureItem[] = [
        {
            ...
            description: "We help organizations assess readiness for Rovo adoption by reviewing data quality, Confluence structure, Jira configurations, and governance practices—ensuring AI insights are accurate and meaningful.",
            icon: Search
        },
        {
            title: "Knowledge & Data Optimization",
            description: "AI is only as good as the data behind it. We help structure Jira and Confluence content so Rovo can surface relevant, trusted, and actionable information.",
            icon: Database
        },
        {
            title: "Use-Case-Driven Adoption",
            description: "We enable Rovo around real business use cases such as faster incident resolution, improved knowledge discovery, executive visibility, and reduced dependency on tribal knowledge.",
            icon: Target
        },
        {
            title: "Change Management & Training",
            description: "We provide role-based enablement to help teams understand how to use Rovo effectively—driving confidence, trust, and adoption of AI-driven workflows.",
            icon: Users
        }
    ]
...
function RovoAcrossToolsSection() {
    const toolItems: FeatureItem[] = [
        {
            title: "Jira Software",
            description: "Smarter insights into work, priorities, and progress for development and project teams.",
            icon: Zap
        },
        {
            title: "Jira Service Management",
            description: "Faster resolution through contextual information and intelligent suggestions for service teams.",
            icon: Lightbulb
        },
        {
            title: "Confluence",
            description: "Intelligent knowledge discovery and answers for documentation and collaboration.",
            icon: Search
        }
    ]
    ...
    const governanceItems: FeatureItem[] = [
        {
            ...
            description: "Ensuring clear data ownership and quality standards for AI-driven insights.",
            icon: Database
        },
        {
            title: "Permission-Aware Access",
            description: "AI insights that respect your existing permission structures and access controls.",
            icon: Shield
        },
        {
            title: "Governance-Aligned Configurations",
            description: "Configurations that align with your organization's governance policies.",
            icon: Target
        },
        {
            title: "Transparency & User Trust",
            description: "Building user trust through transparent AI operations and explainable insights.",
            icon: Users
        }
    ]
        ...
        <section className="container mx-auto px-4 md:px-10">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
                    As organizations scale, information becomes fragmented across tools and teams. Rovo helps reduce noise and surface what matters—turning Atlassian into an intelligent work system rather than just a collection of tools.
                </p>
            </div>
        </section>
    )
