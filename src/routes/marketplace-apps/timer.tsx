      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-10 text-center space-y-8 max-w-5xl">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Time App helps organizations manage and plan resources by providing essential features that minimize cost, improve transparency, and build trust across your team.
          </p>
      ...
      <div className="container mx-auto px-4 md:px-10 space-y-24 md:space-y-32">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Start, pause, and log time directly from any Jira issue with a simple timer panel. Track elapsed time in real-time and log worklogs with a single click when you're done.
            </p>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Admins can easily enable or disable the Work Log Timer for individual projects from a clean configuration page. Control exactly where time tracking is available across your Jira instance.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-slate-700">
                <CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
        ...
        <div className="container mx-auto px-4 md:px-10 max-w-4xl">
          ...
          <div className="space-y-6 text-slate-600">
            <p className="text-lg leading-relaxed">
              <strong className="text-slate-900">Time App</strong> helps organizations manage and plan resources by providing essential set of features that help you minimize cost for your organization. Time App helps provide more transparency, better accountability, project management and helps build trust and better communication across different levels of organization.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 pt-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900">Timer to track time</h3>
                  <p className="text-sm text-slate-600">Track time spent per issue with a simple, intuitive timer panel.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900">Admin Configuration</h3>
                  <p className="text-sm text-slate-600">Configure features per project from a clean admin page.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900">Better Accountability</h3>
                  <p className="text-sm text-slate-600">Improve transparency and communication across teams.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Create better communication across different levels of organization.</p>
                </div>
              </div>
            </div>

            <p className="text-lg leading-relaxed italic border-l-4 border-blue-200 pl-4">
              If you're looking for a way to improve your team's productivity and make better use of your time, consider giving Time App a try.
            </p>
          </div>
        </div>
      </section>
