      ...
      <div className="space-y-16">
        <section>
          <p className="text-xl text-slate-600 leading-relaxed">
            ...
            <span className="text-slate-900 font-semibold underline decoration-purple-300">
        ...
        <section>
          <h2 className="text-3xl font-semibold text-slate-900 mb-8 underline decoration-purple-600 underline-offset-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="group hover:bg-purple-600 p-8 rounded-3xl transition-all duration-300 border border-slate-100 hover:border-purple-600"
              >
                <benefit.icon className="w-10 h-10 text-purple-600 group-hover:text-white mb-6 transition-colors" />
                <h4 className="text-xl font-semibold text-slate-900 group-hover:text-white mb-3 transition-colors">
                  {benefit.title}
                </h4>
                <p className="text-slate-600 group-hover:text-purple-100 transition-colors uppercase tracking-wider text-xs font-semibold">
                  {benefit.desc}
                </p>
              </div>
            ))}
        ...
        <section className="relative overflow-hidden bg-purple-50 rounded-[2.5rem] p-12 border border-purple-100">
          ...
          <h2 className="text-3xl font-semibold mb-8 relative z-10 text-slate-900">
          ...
          <div className="space-y-4 relative z-10">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between p-4 border-b border-purple-100 group hover:bg-white transition-colors"
              >
                <div>
                  <span className="text-purple-600 font-mono text-sm mr-4">
                    0{i + 1}
                  </span>
                ...
                <span className="text-slate-500 text-sm italic group-hover:text-slate-700">
                  {service.text}
                </span>
              </div>
            ))}
        ...
        <section className="flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1">
            <h2 className="text-3xl font-semibold text-slate-900 mb-6 leading-tight">
