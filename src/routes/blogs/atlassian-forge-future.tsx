      ...
      <div className="space-y-12">
        ...
        <section className="bg-purple-50 rounded-3xl p-10 border border-purple-100">
          <h2 className="text-3xl font-semibold mb-6 text-slate-900">
            Our Approach at Achlys Solutions
          </h2>
          ...
          <ul className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <li
                key={i}
                className="flex items-center gap-3 text-slate-700 font-medium bg-white p-4 rounded-xl border border-purple-100 shadow-sm"
              >
